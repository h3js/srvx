...
export type UWSResponse = InstanceType<typeof UWSResponse>;

/**
 * Fast Response for uWebSockets.js runtime
 *
 * It is faster because in most cases it doesn't create a full Response instance.
 */
export const UWSResponse: {
  new (
    body?: BodyInit | null,
    init?: ResponseInit,
  ): globalThis.Response & {
    readonly uwsResponse: () => {
      status: number;
      statusText: string;
  ...
  const _Response = class Response implements globalThis.Response {
    ...
    /**
     * Prepare uWebSockets.js response object
     */
    uwsResponse() {
